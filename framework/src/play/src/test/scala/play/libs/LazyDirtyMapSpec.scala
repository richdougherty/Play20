...
object LazyDirtyMapSpec extends Specification with ScalaCheck {
//
//  sealed trait MapOp {
//    def dirty: Boolean
//    def apply(m: JMap[String,String]): Any
//  }
//  final case object Clear extends MapOp {
//    def dirty = true
//    def apply(m: JMap[String,String]) = m.clear()
//  }
//  final case class Put(k: String, v: String) extends MapOp {
//    def dirty = true
//    def apply(m: JMap[String,String]) = m.put(k, v)
//  }
//  final case class Put(k: String, v: String) extends MapOp {
//    def dirty = true
//    def apply(m: JMap[String,String]) = m.put(k, v)
//  }
//  final case class Put(k: String, v: String) extends MapOp(true)
...
//  }
  ...
  "x" should {
    "y" in {
      val dmap = new LazyDirtyMap[String,String](new JHashMap[String,String]())
      dmap.isDirty must_== false
      dmap.put("a", "1")
      dmap.isDirty must_== true
      dmap.get("a") must_== "1"
    }
  }
}
