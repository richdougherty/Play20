...
public interface BuildDocHandler {
   ...
   *
   * @param request A request of type <code>play.api.mvc.RequestHeader</code>.
   * @return A value of type <code>Option&lt;play.api.mvc.Result&gt;</code> Some if the result was
